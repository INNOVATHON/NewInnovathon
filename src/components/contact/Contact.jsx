...
const Contact = () => {
  ...
  const notify = () => toast.success('Response Submitted!', {
    position: "top-right",
    autoClose: 5000,
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_scxhyf8', 'template_f9i4hxh', form.current, 'XTa25h7uwFqKDQeZQ')
      .then((result) => {
    ...
    >
      ...
      <div className="formContainer">
        ...
        >
          ...
          <input type="email" required placeholder="Email" name="user_email" value="innovathonbits@gmail.com" />
